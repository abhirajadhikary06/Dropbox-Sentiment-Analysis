...
bar_colors = ['#0056E0', '#0050D0', '#0048C0', '#0040B0', '#0038A0']
...
st.markdown("""
    <center>
    <p>Sentiment Analysis of 📥 by <a href="https://github.com/abhirajadhikary06" style='color:#0061FE' target="_blank">abhirajadhikary06</a></p>
    </center>
""", unsafe_allow_html=True)